...
const showOrderFilter = document.querySelector(".orders__table--filter--listWrapper");
const toggleShowOrderFilter = document.querySelector(".orders__table--filter--collapseBtn");
...
const showAbandonedOrderFilter = document.querySelector(".abandoned__table--filter--listWrapper");
...
const showCapturePaymentModal = document.querySelector(".singleOrder__main--modal--capturePayment");
